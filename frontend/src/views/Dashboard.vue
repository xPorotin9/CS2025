    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100">
          <div class="card-body text-center">
            <div
              class="rounded-circle bg-success bg-opacity-10 d-inline-flex align-items-center justify-content-center mb-3"
              style="width: 60px; height: 60px"
            >
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100">
          <div class="card-body text-center">
            <div
              class="rounded-circle bg-info bg-opacity-10 d-inline-flex align-items-center justify-content-center mb-3"
              style="width: 60px; height: 60px"
            >
        ...
        <div class="card border-0 shadow-sm">
          ...
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-4">
                <router-link to="/cursos" class="btn btn-light w-100 text-start p-3">
                  <i class="fas fa-book-open text-primary me-3"></i>
                  <div>
                    <strong>Gestionar Cursos</strong>
                    <br /><small class="text-muted">Administrar cursos y asignaturas</small>
                  </div>
                </router-link>
              </div>
              <div class="col-md-4">
                <router-link to="/docentes" class="btn btn-light w-100 text-start p-3">
                  <i class="fas fa-chalkboard-teacher text-info me-3"></i>
                  <div>
                    <strong>Gestionar Docentes</strong>
                    <br /><small class="text-muted">Administrar personal docente</small>
                  </div>
                </router-link>
              </div>
              <div class="col-md-4">
                <router-link to="/alumnos" class="btn btn-light w-100 text-start p-3">
                  <i class="fas fa-user-graduate text-success me-3"></i>
                  <div>
                    <strong>Gestionar Alumnos</strong>
                    <br /><small class="text-muted">Administrar estudiantes</small>
                  </div>
                </router-link>
              </div>
            </div>
